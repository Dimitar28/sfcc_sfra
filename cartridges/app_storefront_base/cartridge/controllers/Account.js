...
server.get(
    ...
    function (req, res, next) {
        ...
        for (let i = 0; i < profileForm.customer.country.options.length; i++) {
            if (profileForm.customer.country.options[i].value === customer.profile.custom.country.value) {
                profileForm.customer.country.options[i].selected = true;
            } else {
                profileForm.customer.country.options[i].selected = false;
            }
        }
